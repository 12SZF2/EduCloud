...
<template>
  <AdminLayout class="text-white">
    <template #left>
      <section class=" w-full h-full border-r-[1px] border-r-white">
    ...
    <template #right>
      <section class="w-full h-full">
        <section v-if="route.path === '/admin'" class="h-full">
          <div
            class="flex w-full justify-center items-center text-2xl h-[7dvh] font-bold border-b-[1px] border-b-white">
